...
test("2 Invalid ical data", function () {
    expect(1);
    var input = rload1();
...
test("3 No recurrence rule opens empty form with limited Recurrence Type to prevent unlimited Recurrences.", function () {
    expect(2);
...
test("4 Daily recurrence with count", function () {
    expect(5);
